...
<body>
 ...
 <header class="jumbotron back-image" style="background-image:url(images/Banner1.jpg);">
  <div class="myclass mainHeading" div {
  ...
  margin: 20px;
   ...
   <h1 class="text-uppercase text-white font-weight-bold ">Welcome to OSM</h1>
 ...
 <div class="container">
  <div class="jumbotron">
   <h3 class="text-center">OSM Services</h3>
   <p>
     ...
     <div class="col-lg-3 col-sm-6"> <!-- Start 1st Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <h4 class="card-title">Prabhas Aaiyar</h4>
        <p class="card-text">Thank you for creating such website which is saving my lots of time and efforts.</p>
       </div>
      </div>
     </div> <!-- End 1st Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 2nd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <h4 class="card-title">Priya Kumar</h4>
        <p class="card-text">Its such a useful website which provides many functionalities according to users.</p>
       </div>
      </div>
     </div> <!-- End 2nd Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 3rd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <h4 class="card-title">Dev Malbar</h4>
        <p class="card-text">Its really have good experience with this and I really want to share this experience with others</p>
       </div>
      </div>
     </div> <!-- End 3rd Column -->
 ...
 <div class="container" id="Contact">
  ...
  <div class="row">
   ...
   <div class="col-md-4 text-center"> <!-- Start 2nd Column -->
    ...
    OSM pvt Ltd,<br>
    Vadgaon Dhayri, Pune<br>
    Maharashtra - 411041<br>
    Phone: +919765975083<br>
  ...
  <div class="container">
   <div class="row py-3">
    ...
    <div class="col-md-6 text-right"> <!-- Start 2nd Column -->
     <small>Designed by NPM &copy; 2022</small>
