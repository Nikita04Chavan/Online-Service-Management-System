...
<body>
 <!-- Top Navbar -->
 <nav class="navbar navbar-dark fixed-top bg-secondary flex-md-nowrap p-0 shadow"><a class="navbar-brand col-sm-3 col-md-2 mr-0" href="RequesterProfile.php">OSMS</a></nav>
   ...
   <nav class="col-sm-2 bg-light sidebar py-5 d-print-none"> <!-- Start Side Bar 1st Column -->
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <!--<li class="nav-item"><a class="nav-link <?php if(PAGE == 'ServiceBill'){echo 'active';} ?>" href="ServiceBill.php"><i class="fas fa-align-center"></i>Service Bill</a></li>-->
